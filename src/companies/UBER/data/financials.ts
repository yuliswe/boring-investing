...
const financials: SoftwareFinancials = {
  ...
  keyMetrics: [
    {
      label: 'Diluted EPS',
      values: [-6.81, -3.86, -0.29, -4.65, 0.87, 4.56, 4.73, 2.95],
      format: { prefix: '$', decimals: 2 },
      guidanceCount: 1,
    },
    {
      label: 'Operating margin %',
      values: [-66.1, -43.7, -22.0, -5.7, 3.0, 6.4, 10.7, 13.5],
    ...
    {
      label: 'Net margin %',
      values: [-65.4, -60.8, -2.8, -28.7, 5.1, 22.4, 19.3, 10.4],
      format: { suffix: '%', decimals: 1 },
      deltaMode: 'add',
      guidanceCount: 1,
    },
    {
      ...
      values: [-37.8, -30.2, -4.3, 1.2, 9.0, 15.7, 18.8, 18.5],
      format: { suffix: '%', decimals: 1 },
      deltaMode: 'add',
      guidanceCount: 1,
    },
  ...
  expenses: [
    {
      year: 'FY19',
      costOfRevenue: 6.2,
      sellingGeneralAndAdmin: 10.5,
      researchAndDev: 4.9,
      depreciationAndAmortization: 0.5,
      otherOperating: 0,
      nonOperating: -0.2,
      taxes: 0.0,
      dilutionAdjustment: 4.6,
    },
    {
      year: 'FY20',
      costOfRevenue: 5.3,
      sellingGeneralAndAdmin: 8.4,
      researchAndDev: 2.3,
      depreciationAndAmortization: 0.6,
      otherOperating: 0,
      nonOperating: 2.1,
      taxes: -0.2,
    ...
    },
    {
      year: 'FY21',
      costOfRevenue: 9.8,
      sellingGeneralAndAdmin: 9.4,
      researchAndDev: 2.1,
      depreciationAndAmortization: 0.9,
      otherOperating: 0,
      nonOperating: -2.8,
      taxes: -0.5,
      dilutionAdjustment: 1.2,
    },
    {
      year: 'FY22',
      costOfRevenue: 20.2,
      sellingGeneralAndAdmin: 10.6,
      researchAndDev: 2.9,
      depreciationAndAmortization: 0.9,
      otherOperating: 0,
      nonOperating: 7.6,
    ...
    },
    {
      year: 'FY24',
      costOfRevenue: 27.1,
      sellingGeneralAndAdmin: 10.9,
      researchAndDev: 3.2,
      depreciationAndAmortization: 0.7,
      otherOperating: 0,
      nonOperating: -1.3,
      taxes: -5.8,
      dilutionAdjustment: 1.8,
  ...
  thesis: [
    ...
    'Growth in Monthly Active Platform Consumers — 202 million in 2025, up 18% year over year — and increasing cross-platform usage across rides, delivery, grocery, and freight deepen engagement and extend the addressable market.',
  ],
};
