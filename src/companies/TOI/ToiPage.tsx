...
const hero: HeroData = {
  ...
  price: 'CA$127.15',
  changePct: 4.6,
  priceNote: 'TSXV close, 31 December',
  summary:
    ...
    series: [
      {
        ...
        values: [0.494, 0.743, 0.917, 1.125, 1.295, 1.552],
